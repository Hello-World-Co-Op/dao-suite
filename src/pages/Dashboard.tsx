...
export default function Dashboard() {
  ...
  const handleLogout = () => {
    ...
    clearTokenBalance(); // Clear token balance state on logout
    clearTreasury(); // Clear treasury state on logout
    clearBurnPool(); // Clear burn pool state on logout
    clearEscrow(); // Clear escrow state on logout
    navigate('/login');
  };
        ...
        <div className="mb-8">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-gray-600">Hello World DAO Dashboard</p>
            </div>
