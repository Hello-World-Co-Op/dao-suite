...
// Future: Access token is in httpOnly cookie, unavailable to JS.
...
function getAuthHeaders(): HeadersInit {
  // Future: Access token is in httpOnly cookie, unavailable to JS. Use oracle-bridge proxy when available.
