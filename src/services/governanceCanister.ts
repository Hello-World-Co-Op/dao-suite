...
// Mock proposal list data for development (Story 9-1-3)
const mockProposalList: ProposalListItem[] = [
  {
    id: 'prop-001',
    title: 'Community Garden Initiative - Phase 1 Implementation',
    proposer: 'mock-user-principal-1',
    status: 'Active',
    votesFor: 45,
    votesAgainst: 12,
    votesAbstain: 8,
  ...
  },
  {
    ...
    proposer: 'mock-user-principal-2',
    status: 'Active',
    votesFor: 78,
    votesAgainst: 5,
    votesAbstain: 3,
    votingEndsAt: Date.now() + 3 * 24 * 60 * 60 * 1000, // 3 days
    createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-003',
    title: 'Educational Workshop Series Funding',
    proposer: 'mock-user',
    status: 'Active',
    votesFor: 23,
    votesAgainst: 8,
    votesAbstain: 2,
    votingEndsAt: Date.now() + 7 * 24 * 60 * 60 * 1000, // 7 days
    createdAt: Date.now() - 1 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-004',
    title: 'Community Food Cooperative Expansion',
    proposer: 'mock-user-principal-3',
    status: 'Passed',
    votesFor: 156,
    votesAgainst: 23,
    votesAbstain: 12,
    votingEndsAt: Date.now() - 3 * 24 * 60 * 60 * 1000, // Ended
    createdAt: Date.now() - 14 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-005',
    title: 'Emergency Housing Fund Allocation',
    proposer: 'mock-user',
    status: 'Passed',
    votesFor: 203,
    votesAgainst: 45,
    votesAbstain: 18,
    votingEndsAt: Date.now() - 7 * 24 * 60 * 60 * 1000, // Ended
    createdAt: Date.now() - 21 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-006',
    title: 'New Office Space Lease Proposal',
    proposer: 'mock-user-principal-1',
    status: 'Failed',
    votesFor: 34,
    votesAgainst: 89,
    votesAbstain: 22,
    votingEndsAt: Date.now() - 5 * 24 * 60 * 60 * 1000, // Ended
    createdAt: Date.now() - 12 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-007',
    title: 'Treasury Reserve Increase',
    proposer: 'mock-user-principal-4',
    status: 'Pending',
    votesFor: 0,
    votesAgainst: 0,
    votesAbstain: 0,
    votingEndsAt: Date.now() + 14 * 24 * 60 * 60 * 1000, // 14 days (pending review)
    createdAt: Date.now() - 12 * 60 * 60 * 1000, // 12 hours ago
  },
  {
    id: 'prop-008',
    title: 'Member Onboarding Process Improvement',
    proposer: 'mock-user-principal-2',
    status: 'Pending',
    votesFor: 0,
    votesAgainst: 0,
    votesAbstain: 0,
    votingEndsAt: Date.now() + 14 * 24 * 60 * 60 * 1000,
    createdAt: Date.now() - 6 * 60 * 60 * 1000, // 6 hours ago
  },
  {
    id: 'prop-009',
    title: 'Annual Budget Review and Approval',
    proposer: 'mock-user-principal-5',
    status: 'Active',
    votesFor: 112,
    votesAgainst: 34,
    votesAbstain: 28,
    votingEndsAt: Date.now() + 2 * 24 * 60 * 60 * 1000, // 2 days - ending soon!
    createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000,
  },
  {
    id: 'prop-010',
    title: 'Infrastructure Maintenance Fund',
    proposer: 'mock-user',
    status: 'Active',
    votesFor: 67,
    votesAgainst: 12,
    votesAbstain: 5,
    votingEndsAt: Date.now() + 4 * 24 * 60 * 60 * 1000,
  ...
  },
  {
    ...
    proposer: 'mock-user-principal-6',
    status: 'Failed',
    votesFor: 45,
    votesAgainst: 78,
    votesAbstain: 34,
    votingEndsAt: Date.now() - 8 * 24 * 60 * 60 * 1000,
